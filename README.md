...
* Drag the segmentation result in .nii.gz file in folder 'seg' into the software `ITK-Snap`[Download link](http://www.itksnap.org/pmwiki/pmwiki.php?n=Downloads.SNAP3), along with the orginal nii.gz file from any of the four modalities t1, t1ce, t2, flair, then the segmentation result on the brain can be visualized.
